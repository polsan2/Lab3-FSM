...
VL_INLINE_OPT void Vf1_fsm___024root___nba_sequent__TOP__0(Vf1_fsm___024root* vlSelf) {
    ...
    // Body
    vlSelf->f1_state_machine__DOT__current_state = 
        ((IData)(vlSelf->rst) ? 0U : ((IData)(vlSelf->en)
                                       ? vlSelf->f1_state_machine__DOT__next_state
                                       : vlSelf->f1_state_machine__DOT__current_state));
    if (((((((((0U == vlSelf->f1_state_machine__DOT__current_state) 
               | (1U == vlSelf->f1_state_machine__DOT__current_state)) 
              | (2U == vlSelf->f1_state_machine__DOT__current_state)) 
             | (3U == vlSelf->f1_state_machine__DOT__current_state)) 
            | (4U == vlSelf->f1_state_machine__DOT__current_state)) 
           | (5U == vlSelf->f1_state_machine__DOT__current_state)) 
          | (6U == vlSelf->f1_state_machine__DOT__current_state)) 
         | (7U == vlSelf->f1_state_machine__DOT__current_state))) {
        if ((0U == vlSelf->f1_state_machine__DOT__current_state)) {
            vlSelf->f1_state_machine__DOT__next_state = 1U;
            vlSelf->data_out = 0U;
        } else if ((1U == vlSelf->f1_state_machine__DOT__current_state)) {
            vlSelf->f1_state_machine__DOT__next_state = 2U;
            vlSelf->data_out = 1U;
        } else if ((2U == vlSelf->f1_state_machine__DOT__current_state)) {
            vlSelf->f1_state_machine__DOT__next_state = 3U;
            vlSelf->data_out = 3U;
        } else if ((3U == vlSelf->f1_state_machine__DOT__current_state)) {
            vlSelf->f1_state_machine__DOT__next_state = 4U;
            vlSelf->data_out = 7U;
        } else if ((4U == vlSelf->f1_state_machine__DOT__current_state)) {
            vlSelf->f1_state_machine__DOT__next_state = 5U;
            vlSelf->data_out = 0xfU;
        } else if ((5U == vlSelf->f1_state_machine__DOT__current_state)) {
            vlSelf->f1_state_machine__DOT__next_state = 6U;
            vlSelf->data_out = 0x1fU;
        } else if ((6U == vlSelf->f1_state_machine__DOT__current_state)) {
            vlSelf->f1_state_machine__DOT__next_state = 7U;
            vlSelf->data_out = 0x3fU;
        } else {
            vlSelf->f1_state_machine__DOT__next_state = 8U;
            vlSelf->data_out = 0x7fU;
        }
    } else {
        vlSelf->f1_state_machine__DOT__next_state = 0U;
        if ((8U == vlSelf->f1_state_machine__DOT__current_state)) {
