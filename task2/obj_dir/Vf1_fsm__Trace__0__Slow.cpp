...
VL_ATTR_COLD void Vf1_fsm___024root__trace_init_sub__TOP__0(Vf1_fsm___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->pushNamePrefix("f1_state_machine ");
    tracep->declBit(c+1,"clk", false,-1);
    tracep->declBit(c+2,"en", false,-1);
    tracep->declBit(c+3,"rst", false,-1);
    tracep->declBus(c+4,"data_out", false,-1, 7,0);
...
VL_ATTR_COLD void Vf1_fsm___024root__trace_full_sub_0(Vf1_fsm___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+5,(vlSelf->f1_state_machine__DOT__current_state),32);
    bufp->fullIData(oldp+6,((((((((((0U == vlSelf->f1_state_machine__DOT__current_state) 
                              ...
                              ? ((0U == vlSelf->f1_state_machine__DOT__current_state)
                                  ? 1U : ((1U == vlSelf->f1_state_machine__DOT__current_state)
                                           ? 2U : (
                                                   (2U 
